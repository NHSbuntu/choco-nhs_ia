...
$packageName= 'nhs_ia' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://nww.hscic.gov.uk/dir/downloads/NHS-Digital-Identity-Agent-2.1.2.16.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'nhs_ia*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided.
  # You can also use checksum.exe (choco install checksum) and use it
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'af32a9834628cfc4c56e681e0c053db07edfdc0013a002fcda80b9515533def2'
